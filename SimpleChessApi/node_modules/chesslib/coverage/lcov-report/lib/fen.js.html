...
<html lang="en">
<head>
    <title>Code coverage report for lib/fen.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/fen.js</span></h1>
    <h2>
        
        Statements: <span class="metric">98.96% <small>(95 / 96)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">95.24% <small>(40 / 42)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; fen.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2223</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-yes">206</span>
<span class="cline-any cline-yes">206</span>
<span class="cline-any cline-yes">1648</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">13184</span>
<span class="cline-any cline-yes">13184</span>
<span class="cline-any cline-yes">6729</span>
<span class="cline-any cline-yes">6729</span>
<span class="cline-any cline-yes">841</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">6729</span>
<span class="cline-any cline-neutral">&nbsp;</span>
  ...
  for (var i = 0; i &lt; 8; i++) {
    for (var j = 0,
      ...
      if (piece == null) {
        count += 1;
        if (j === 7) {
          ranks += ("" + (count ? count : <span class="branch-1 cbranch-no" title="branch not covered" >'')</span> + (i !== 7 ? '/' : ''));
        }
        continue;
      }
...
function stringifyClock(clock) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (String(clock) === '0') {
    return clock.source;
  }
<span class="cstat-no" title="statement not covered" >  return String(clock);</span>
}
