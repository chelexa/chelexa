...
<html lang="en">
<head>
    <title>Code coverage report for lib/castling.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/castling.js</span></h1>
    <h2>
        
        Statements: <span class="metric">94.94% <small>(75 / 79)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">85.71% <small>(48 / 56)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(16 / 16)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">94.94% <small>(75 / 79)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; castling.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">2465</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2465</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4804</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">2433</span>
<span class="cline-any cline-yes">2433</span>
<span class="cline-any cline-yes">2407</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2433</span>
<span class="cline-any cline-yes">2268</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2224</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">26</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
($traceurRuntime.createClass)(Castling, {
  ...
  analyze: function(position, king, coords) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!isValid(position, color, side)) {
<span class="cstat-no" title="statement not covered" >      throw new CheckError();</span>
    }
...
function parseCastlingModes(castling) {
  var modes = blankModes();
  String(castling || <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>.split('').forEach((function(mode) {
...
function xOffset(color, side) {
  var m = arguments[2] !== (void 0) ? arguments[2] : <span class="branch-1 cbranch-no" title="branch not covered" >1;</span>
  if (color === WHITE) {
    if (side === KINGSIDE) {
      return m;
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (side === QUEENSIDE) {
      return -m;
    }
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (color === BLACK) {
    if (side === KINGSIDE) {
      return -m;
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (side === QUEENSIDE) {
      return m;
...
function isValid(position, color, side) {
  ...
  for (var $__6 = loc.to(loc.sum(Castling.kingOffset(color, side)))[$traceurRuntime.toProperty(Symbol.iterator)](),
      $__7; !($__7 = $__6.next()).done; ) {
<span class="cstat-no" title="statement not covered" >    var pt = $__7.value;</span>
    {
<span class="cstat-no" title="statement not covered" >      if (position.isCheck(color, pt)) {</span>
